...
var routes = [
    ...
    { path: 'toernooi-index/:id', component: index_component_1.CompetitionSeasonIndexComponent, data: { inCompetitionSeason: true } },
    { path: 'toernooi-structuur/:id', component: structure_component_1.CompetitionSeasonStructureComponent, data: { inCompetitionSeason: true } },
