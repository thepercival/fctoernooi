...
var AppConfig = (function () {
    ...
    AppConfig.prototype.load = function () {
        ...
        return new Promise(function (resolve, reject) {
            _this.http.get('configs/env.json').map(function (res) { return res.json(); }).catch(function (error) {
                ...
                switch (envResponse.env) {
                    case 'production':
                        {
                            request = _this.http.get('configs/' + envResponse.env + '.json');
                        }
                        break;
                    case 'development':
                        {
